class Config {
    ...
    PRODUCT_URL = `${this.SCHEME}://${this.HOST}:${this.PORT}/api/v1/auth/products`;
    CART_URL = `${this.SCHEME}://${this.HOST}:${this.PORT}/api/v1/auth/carts`;
    ORDER_URL = `${this.SCHEME}://${this.HOST}:${this.PORT}/api/v1/auth/orders`;
    CUSTOMER_URL = `${this.SCHEME}://${this.HOST}:${this.PORT}/api/v1/auth/customers`;
